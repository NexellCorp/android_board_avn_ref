...
if [ -f ${UBOOT_DIR}/u-boot.bin ]; then
	...
	UBOOT_BOOTARGS="console=ttyAMA3,115200n8 loglevel=7 printk.time=1 androidboot.hardware=avn_ref androidboot.console=ttyAMA3 androidboot.serialno=0123456789ABCDEF nx_drm.fb_buffers=3 nx_drm.fb_vblank nx_drm.fb_pan_crtcs=0x1 quiet"
