...
UBOOT_BOOTARGS="console=ttyAMA3,115200n8 loglevel=7 printk.time=1 androidboot.hardware=avn_ref androidboot.console=ttyAMA3 androidboot.serialno=s5p4418_avn_ref nx_drm.fb_buffers=3 nx_drm.fb_vblank"
